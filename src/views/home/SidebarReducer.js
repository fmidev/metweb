...
const updateActiveProducts = (menuObject, windows) => {
...
const getSelectedWindowConfig = (windows) => {
  var selectedWindowId = windows.getSelected();
  var config = windows.get(selectedWindowId)
  return config;
}
const setSelectedWindowConfig = (windows, config) => {
  var selectedWindowId = windows.getSelected();
  windows.set(selectedWindowId, config)
}


const addProductToActiveMap = (product, windows) => {
...
const removeProductFromActiveMap = (product, windows) => {
...
const generateConfigForProduct = (title, layer, type, source, windows) => {
